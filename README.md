...
tests/booking.generated.spec.ts  흐름형 결과물 (실제로 돌려본 출력)
tests/report.generated.spec.ts   조회형 결과물 (실제로 돌려본 출력)
...
npm run build:spec:report     # tests/report.generated.spec.ts 생성
